...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"Carregando...", None))
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Un</strong>Problem", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>LUGAR DOS</strong> PREGUIÇOSOS", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"carregando...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Criado por</strong>: Rafael Rocha", None))